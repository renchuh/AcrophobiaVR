...
namespace Wave.OpenXR.CompositionLayer.Passthrough
{
#if UNITY_EDITOR
	...
	{
		const string LOG_TAG = "Wave.OpenXR.ViveCompositionLayerPassthrough";
		...
		/// </summary>
		public const string featureId = "vive.wave.openxr.feature.compositionlayer.passthrough";
		...
		private static extern int WaveOpenXR_HTCPassthrough_CreatePassthrough(XrSession session, LayerType layerType, PassthroughLayerForm layerForm, uint compositionDepth = 0);
		public int HTCPassthrough_CreatePassthrough(LayerType layerType, PassthroughLayerForm layerForm, OnPassthroughSessionDestroyDelegate onDestroyPassthroughHandler, uint compositionDepth = 0)
		{
			...
			int passthroughID = WaveOpenXR_HTCPassthrough_CreatePassthrough(m_XrSession, layerType, layerForm, compositionDepth);
		...
		private static extern bool WaveOpenXR_HTCPassthrough_SetAlpha(int passthroughID, float alpha);
		public bool HTCPassthrough_SetAlpha(int passthroughID, float alpha)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetAlpha(passthroughID, alpha);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_SetLayerType")]
		private static extern bool WaveOpenXR_HTCPassthrough_SetLayerType(int passthroughID, LayerType layerType, uint compositionDepth = 0);
		public bool HTCPassthrough_SetLayerType(int passthroughID, LayerType layerType, uint compositionDepth = 0)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetLayerType(passthroughID, layerType, compositionDepth);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_SetMesh")]
		private static extern bool WaveOpenXR_HTCPassthrough_SetMesh(int passthroughID, uint vertexCount, [In, Out] XrVector3f[] vertexBuffer, uint indexCount, [In, Out] uint[] indexBuffer);
		public bool HTCPassthrough_SetMesh(int passthroughID, uint vertexCount, [In, Out] XrVector3f[] vertexBuffer, uint indexCount, [In, Out] uint[] indexBuffer)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetMesh(passthroughID, vertexCount, vertexBuffer, indexCount, indexBuffer);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_SetMeshTransform")]
		private static extern bool WaveOpenXR_HTCPassthrough_SetMeshTransform(int passthroughID, XrSpace meshSpace, XrPosef meshPose, XrVector3f meshScale);
		public bool HTCPassthrough_SetMeshTransform(int passthroughID, XrSpace meshSpace, XrPosef meshPose, XrVector3f meshScale)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetMeshTransform(passthroughID, meshSpace, meshPose, meshScale);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_SetMeshTransformSpace")]
		private static extern bool WaveOpenXR_HTCPassthrough_SetMeshTransformSpace(int passthroughID, XrSpace meshSpace);
		public bool HTCPassthrough_SetMeshTransformSpace(int passthroughID, XrSpace meshSpace)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetMeshTransformSpace(passthroughID, meshSpace);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_SetMeshTransformPosition")]
		private static extern bool WaveOpenXR_HTCPassthrough_SetMeshTransformPosition(int passthroughID, XrVector3f meshPosition);
		public bool HTCPassthrough_SetMeshTransformPosition(int passthroughID, XrVector3f meshPosition)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetMeshTransformPosition(passthroughID, meshPosition);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_SetMeshTransformOrientation")]
		private static extern bool WaveOpenXR_HTCPassthrough_SetMeshTransformOrientation(int passthroughID, XrQuaternionf meshOrientation);
		public bool HTCPassthrough_SetMeshTransformOrientation(int passthroughID, XrQuaternionf meshOrientation)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetMeshTransformOrientation(passthroughID, meshOrientation);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_SetMeshTransformScale")]
		private static extern bool WaveOpenXR_HTCPassthrough_SetMeshTransformScale(int passthroughID, XrVector3f meshScale);
		public bool HTCPassthrough_SetMeshTransformScale(int passthroughID, XrVector3f meshScale)
		{
			...
			return WaveOpenXR_HTCPassthrough_SetMeshTransformScale(passthroughID, meshScale);
		}

		[DllImportAttribute(ExtLib, EntryPoint = "htcpassthrough_DestroyPassthrough")]
		private static extern bool WaveOpenXR_HTCPassthrough_DestroyPassthrough(int passthroughID);
		public bool HTCPassthrough_DestroyPassthrough(int passthroughID)
		{
			...
			bool destroyed = WaveOpenXR_HTCPassthrough_DestroyPassthrough(passthroughID);
		...
		private static extern XrResult WaveOpenXR_HTCPassthrough_GetFuncAddrs(XrInstance xrInstance, IntPtr xrGetInstanceProcAddrFuncPtr);
		private XrResult HTCPassthrough_GetFuncAddrs(XrInstance xrInstance, IntPtr xrGetInstanceProcAddrFuncPtr)
		{
			if (!HTCPassthroughExtensionEnabled)
			{
				ERROR("WaveOpenXR_HTCPassthrough_GetFuncAddrs: " + kOpenxrExtensionStrings + " is NOT enabled.");
				return XrResult.XR_ERROR_FEATURE_UNSUPPORTED;
			}

			return WaveOpenXR_HTCPassthrough_GetFuncAddrs(xrInstance, xrGetInstanceProcAddrFuncPtr);
		}
